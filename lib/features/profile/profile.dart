...
class _ShowProfileState extends State<ShowProfile> {
  ...
  void first_name(String name) async {
    http.Response response = await updateString(
        "https://verinvest.up.railway.app/profile/first_name/", name);
    print(response.body);
  }

  void last_name(String name) async {
    http.Response response = await updateString(
        "https://verinvest.up.railway.app/profile/last_name/", name);
    print(response.body);
  }

  void email(String name) async {
    http.Response response = await updateString(
        "https://verinvest.up.railway.app/profile/email/", name);
    print(response.body);
  }

  void birth_date(String name) async {
    http.Response response = await updateString(
        "https://verinvest.up.railway.app/profile/birthdate/", name);
    print(response.body);
  }

  void occupation(String name) async {
    http.Response response = await updateString(
        "https://verinvest.up.railway.app/profile/occupation/", name);
    print(response.body);
  }
                ...
                return Container(
                    ...
                    child: Column(children: [
                      ...
                      Padding(
                          ...
                          child: Text(
                            "Hello, ${profile.fields.first_name} ${profile.fields.last_name}!",
